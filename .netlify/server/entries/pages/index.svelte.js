  ...
  to {
    ...
    <section class="${"o-main-section"}"><h2 class="${"c-main-heading"}">Hey there, I&#39;m Hamid.</h2>
      ...
      <article class="${"c-article"}"><a class="${"c-article__link"}"><div><style>.ryersonuni {
            ...
            <header><h3 class="${"c-article__heading"}" id="${"about"}">A learning developer, in the middle of getting a CS degere at
                the <a class="${"ryersonuni"}" href="${"https://www.torontomu.ca/"}">Ryerson/TMU</a></h3></header></div>
      ...
      <article class="${"c-article"}"><a class="${"c-article__link"}"><div><header><style>@import url("https://fonts.googleapis.com/css2?family=Roboto:wght@900&display=swap");
              ...
              <h3 class="${"c-article__heading background"}"><a>Experienced working with <a class="${"swift"}">Swift\u{1F426}</a>, <a class="${"js"}">Js</a>, HTML /
                  <a class="${"css"}">CSS</a>
...
#laptop__code {
  transform: rotateX(-37deg) rotateY(-46deg) rotateZ(-23deg) translateX(8px) translateY(20px) translateZ(-50px);
      ...
      <article class="${"c-article"}"><a class="${"c-article__link"}"><div><header><h3 class="${"c-article__heading"}">Open to New Experiences, and always <div id="${"flip"}"></div>
  ...
  <div class="${"c-author"}">Built with \u{1F49B}&amp;\u2615 by <a target="${"_blank"}" class="${"c-author__link"}" href="${""}">Hamidreza Khoramrokh</a></div>
</html>`;
});
